    ...
    <>
      ...
      <main className={sGrotesk.className}>
        <section className="home-banner-area pb-[150px] pt-[100px]">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#2A30E9" fillOpacity="1" d="M0,0L40,5.3C80,11,160,21,240,21.3C320,21,400,11,480,53.3C560,96,640,192,720,208C800,224,880,160,960,117.3C1040,75,1120,53,1200,90.7C1280,128,1360,224,1400,272L1440,320L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fillOpacity="1" d="M0,0L40,5.3C80,11,160,21,240,21.3C320,21,400,11,480,53.3C560,96,640,192,720,208C800,224,880,160,960,117.3C1040,75,1120,53,1200,90.7C1280,128,1360,224,1400,272L1440,320L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
        </section>
        {/* feature area  */}
